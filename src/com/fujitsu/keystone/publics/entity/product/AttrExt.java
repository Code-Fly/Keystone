...
public class AttrExt extends BaseEntity {
    ...
    /**
     * @param isPostFree the isPostFree to set
     */
    ...
    /**
     * @param isHasReceipt the isHasReceipt to set
     */
    ...
    /**
     * @param isUnderGuaranty the isUnderGuaranty to set
     */
    ...
    /**
     * @param isSupportReplace the isSupportReplace to set
     */
