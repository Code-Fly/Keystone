...
public class OrderBase extends BaseEntity {
    ...
    /**
     * @param order_total_price the order_total_price to set
     */
    ...
    /**
     * @param order_create_time the order_create_time to set
     */
    ...
    /**
     * @param order_express_price the order_express_price to set
     */
    ...
    /**
     * @param buyer_openid the buyer_openid to set
     */
    ...
    /**
     * @param receiver_province the receiver_province to set
     */
    ...
    /**
     * @param receiver_zone the receiver_zone to set
     */
